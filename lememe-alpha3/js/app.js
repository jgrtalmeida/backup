var font_list = $('#meme-fonts > li'),
	...
	//api_key = $('#api-key'),
	api_key = '6f1128f5d48105dc3f785f78e84d82592de44b08', //Access token sacado de Imgur
	album_id = "e7l7A" //album id que aparece en el url final de imgur
...
function generate_meme(e) {
    ...
    //xhr.setRequestHeader ("Authorization", "Client-ID da710a9553cba78");
    xhr.setRequestHeader ("Authorization", "Bearer "+ api_key); //acá va el puto access token
		},
...
function register_events() {
	...
	$(document).on('drop', function(e) {
		...
		if (data.files.length === 1) {
			...
			Notifier.error('Muchas imágenes', 'puedes poner solamente una imagen a la vez');
		}
		e.preventDefault();
		return false;
	});
